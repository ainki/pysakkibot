...
module.exports = {
    admin: function (chatId) {
        if (chatId == 81023943 || chatId == 86734737) {
            console.info("Admin tunnistettu")
            let replyMarkup = bot.keyboard([
                ['/adminhairio'],
            ], { resize: true });
            return bot.sendMessage(chatId, `Admin menu:`, { replyMarkup })
        } else {
            console.info("Adminia ei tunnistettu")
        }
    },
    adminhairio: function (chatId) {
        ...
        if (chatId == 81023943 || chatId == 86734737) {
            ...
            if (hetki == "Hetkinen...") {
                ...
                return console.info("Admin - Häiriö viesti lisätty!")
            } else {
                //Vaihtaa muuttijien viestin
                hetki = "Hetkinen..."
                hetki2 = "Haetaan aikatauluja..."
                ...
                return console.info("Admin - Häiriö viesti poistettu!")
            }
        } else {
            console.info("Adminia ei tunnistettu")
        }
