...
bot.on('ask.pysakkinimi', msg => {
    ...
    if (text == "/start" || text == undefined || text.includes("/hae") || text == "/help" || text == "/linja" || text == "/menu" || text == "/about") {
...
bot.on('ask.askpysakkivalinta', msg => {
    ...
    //Komennot jotka ei tee pysökkihakua
    if (valinta == "/start" || valinta == undefined || valinta.includes("/hae") || valinta == "/help" || valinta == "/linja" || valinta == "/menu" || valinta == "/about") {
        //Keskeytetään kysymys
    } else {
