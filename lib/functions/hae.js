...
bot.on('ask.pysakkinimi', msg => {
  ...
  if (text == "/start" || text == undefined || text.includes("/hae") || text == "/help" || text.includes("/linja") || text == "/menu" || text == "/about" || text == "/poikkeukset"|| text.includes("/pysakki")) {
    ...
    .then(function (data) {
      ...
      if (vastaus == tyhjavastaus) {
        ...
        for (i = 0; i < pysakit.length; i++) {
          ...
          if (laiturit[i] === null && koodit[i] !== null) {
          ...
          } else if(laiturit[i] !== null && koodit[i] !== null) {
        ...
        console.log(nappainvaihtoehdot, viestivaihtoehdot);
...
bot.on('ask.askpysakkivalinta', msg => {
  ...
  //Komennot jotka ei tee pysökkihakua
  if (valinta == "/start" || valinta == undefined || valinta.includes("/hae") || valinta == "/help" || valinta.includes("/linja") || valinta == "/menu" || valinta == "/about" || valinta == "/poikkeukset" || valinta.includes("/pysakki")) {
