                    ...
                    if (realtimeTila[i] == 'SCHEDULED') {
                        ...
                        if (pickupType[i] == 'SCHEDULED') {
                            if (alert == "") {
                                ...
                                var yksittainenlahto = departuretimeshort + "‏‏‎     " + linjatunnus[i] + " " + maaranpaa +  "  ⚠️\n";
                                poikkeus = true
                            }
