...
function maaranpaat(chatId, viesti) {
    ...
    return request(digiAPI, query)
        .then(function (data) {
            ...
            // Tekee elementin joka tallentaa tarvittavan datan linjakoodeihin seuraavaa vaihetta varten
            var element = {};
            ...
            if (iideet[i] == chatId) {
                ...
                for (i = 0; i < headsign.length; i += 1) {
                    ...
                    if (maaranpaa == valinta) {
                        ...
                        // Linjakoodit kakkoseen tarvittava aikataulunjen hakemista varten varten
                        var element = {};
...
function pysakkihaku(chatId, code) {
    ...
    return request(digiAPI, query)
        .then(function (data) {
            ...
            // Väliaikainen ratkaisu. Siistitään myöhemmin
            nappaimisto2 = nappaimisto.splice(0, Math.ceil(nappaimisto.length / 2));
