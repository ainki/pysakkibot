...
if (valinta && valinta !== "/start" && !valinta.includes("/hae") && !valinta.includes("/help") && !valinta.includes("/linja") && !valinta.includes("/menu") && !valinta.includes("/about") &&  !valinta.includes("/poikkeukset") &&  !valinta.includes("/pys") && !valinta.includes("/pysakki") && !valinta.includes("/liitynta") && !valinta.includes("/reitti")) {
//jos ei ole
