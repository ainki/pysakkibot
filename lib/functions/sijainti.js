                ...
                if (vastaus === tyhjavastausLOC) {
                  ...
                  pysakit = nodehaku.reduce((a,e) => {
                    // a on viimeks returnattu arvo, johon kertyy pushin kaut arvoi; e on tänhetkinen arvo iteroinnis
                      ...
                      pysahdykset.push({koodi: koodi, pysakkinimi: pysakkinimi, lahtoaika: stoptimes.realtimeDeparture, distance: distance, realtime: stoptimes.realtime, lahtopaiva: stoptimes.serviceDay, shortname: shortname, headsign: headsign});
