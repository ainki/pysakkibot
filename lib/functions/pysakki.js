...
const numMaara = require('./numMaara');
var nappaimisto;
...
console.log("nappainvaihtoehdot.lengt",nappainvaihtoehdot.length,viesti);
...
lahetaPysakinSijainti(chatId, data.stops[0].lat, data.stops[0].lon)
      ...
      var valintaArr = []
      valintaArr.push(valinta)
      var nappaimisto = chunkArray(["/pys " + koodit[0]], 1);
      let replyMarkup = bot.keyboard(nappaimisto, { resize: true });
koodit = [];
