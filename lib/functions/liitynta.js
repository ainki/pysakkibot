...
return 0;
 ...
 //Haetaan kysyttyä liityntaa arraysta
    ...
    } else if (!loyty && viesti.trim() !== "/liitynta" && viesti == "/start" && viesti !== undefined && !viesti.includes("/hae") && viesti !== "/help" && !viesti.includes("/linja") && viesti !== "/menu" && viesti !== "/about" && viesti !== "/poikkeukset" && !viesti.includes("/pys") && !viesti.includes("/pysakki")) {
        //ei löydy
